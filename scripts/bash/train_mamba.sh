...
#SBATCH --error=results/mamba/error_train_streaming%a.log
#SBATCH --output=results/mamba/output_train_streaming_%a.log

source $WORK/miniconda3/etc/profile.d/conda.sh
conda activate litgpt_jz

python scripts/train/train_mamba.py \
   --output-dir results/mamba\
