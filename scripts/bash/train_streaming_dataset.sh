...
#SBATCH --error=results/baseline_orc_augmented/error_train_streaming%a.log
#SBATCH --output=results/baseline_orc_augmented/output_train_streaming_%a.log

source $WORK/miniconda3/etc/profile.d/conda.sh
conda activate litgpt_jz

python scripts/train/streaming_dataset.py \
   --output-dir results/baseline_orc_augmented\
