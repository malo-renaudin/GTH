...
#SBATCH --error=results/orc_augmented_full_datasets/error_train_streaming%a.log
#SBATCH --output=results/orc_augmented_full_datasets/output_train_streaming_%a.log

source $WORK/miniconda3/etc/profile.d/conda.sh
conda activate litgpt_jz

python scripts/train/streaming_dataset.py \
   --output-dir results/orc_augmented_full_datasets\
